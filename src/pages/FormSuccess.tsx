...
const DEFAULT_CONFIG: SuccessConfig = {
  title: "Form Submitted Successfully!",
  subtitle: "Thank you for your submission",
  description:
    "We have received your form submission and will process it shortly.",
  nextSteps: [
...
const CONFIG_MAP: Record<string, SuccessConfig> = {
  ydp: {
    title: "YDP Application Submitted!",
    subtitle: "Youth Development Program Application",
    description:
      "Thank you for applying to our Youth Development Program. We're excited to review your application and help you start your journey in ethical innovation.",
    nextSteps: [
    ...
    additionalInfo:
      "YDP is perfect for Grades 9-10 students looking to explore career paths in technology and business.",
  },
  ssp: {
    title: "SSP Application Submitted!",
    subtitle: "Senior Secondary Program Application",
    description:
      "Thank you for applying to our Senior Secondary Program. We look forward to helping you specialize in your chosen field and prepare for your career.",
    nextSteps: [
      "Application confirmation sent to your email",
    ...
    estimatedResponse: "5-7 business days",
    additionalInfo:
      "SSP offers specialized tracks in AI/ML, UX Design, Business Strategy, and Cybersecurity.",
  },
  epc: {
    title: "EPC Application Submitted!",
    subtitle: "Ethical Professional Core Application",
    description:
      "Thank you for applying to our Ethical Professional Core program. This foundation program will strengthen your ethical decision-making skills.",
    nextSteps: [
      "Application confirmation sent to your email",
    ...
    additionalInfo:
      "EPC integrates with all our programs to provide a strong ethical foundation.",
  },
  erwa: {
    title: "ERWA Application Submitted!",
    subtitle: "Real-World Application Program",
    description:
      "Thank you for applying to our Real-World Application program. Get ready for hands-on experience with industry projects.",
    nextSteps: [
      "Application confirmation sent to your email",
    ...
    estimatedResponse: "3-5 business days",
    additionalInfo:
      "ERWA includes hackathons, startup simulations, and NGO collaborations.",
  },
  ecp: {
    title: "ECP Application Submitted!",
    subtitle: "Ethical Capstone Project Application",
    description:
      "Thank you for applying to our Capstone Project program. We're excited to see what innovative solution you'll create.",
    nextSteps: [
      "Application confirmation sent to your email",
    ...
    estimatedResponse: "5-7 business days",
    additionalInfo:
      "ECP is the culminating experience where you create real solutions to meaningful problems.",
  },
  mentor: {
    title: "Mentor Application Submitted!",
    subtitle: "Thank you for applying to become a mentor",
    description:
      "We're excited about having you join our mentor community. Your expertise can make a real difference in students' lives.",
    nextSteps: [
      "Application confirmation sent to your email",
    ...
    estimatedResponse: "5-7 business days",
    additionalInfo:
      "We carefully match mentors with students based on expertise and interests.",
  },
  school: {
    title: "School Partnership Inquiry Submitted!",
    subtitle: "Thank you for your interest in partnering",
    description:
      "We're excited about partnering with your school to bring transformative education to your students.",
    nextSteps: [
    ...
    additionalInfo:
      "We customize our programs to fit your school's unique needs and schedule.",
  },
};
...
const FormSuccess: React.FC = () => {
  ...
  const [config, setConfig] = useState<SuccessConfig>(DEFAULT_CONFIG);

  useEffect(() => {
    // Read ?type=... or ?program=...
    const program = params.get("program")?.toLowerCase() || "";
    const type = params.get("type")?.toLowerCase() || "general";

    const chosen =
      (program && CONFIG_MAP[program]) ||
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-2xl w-full">
        <div className="professional-card-lg shadow-professional-xl text-center bg-white">
          {/* Success Icon */}
          <div
            className={`w-20 h-20 ${colorClasses.bg} rounded-full flex items-center justify-center mx-auto mb-6`}
          >
            ...
            <ul className="space-y-3">
              {config.nextSteps.map((step, index) => (
                <li key={index} className="flex items-start">
                  <span
                    className={`w-6 h-6 ${colorClasses.bg} ${colorClasses.text} rounded-full flex items-center justify-center text-sm font-semibold mr-3 mt-0.5 flex-shrink-0`}
                  >
                    {index + 1}
                  </span>
